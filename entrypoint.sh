...
function launchVanillaServer {
    ...
    echo -e "\e[38;2;129;170;254m[INFO] \e[38;5;250mRemember! You can change the Server Software you're using by deleting the \"system\" file in the File Manager and restarting the server.\e[0m"
...
function optimize_server {
    ...
    curl -o $HOME/plugins/Hibernate.jar https://aether.votion.dev/Hibernate-2.1.0.jar
}
